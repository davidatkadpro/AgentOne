...
|---|---|---|---|
| P0 Backend route gaps (P3P1-P3P8) | 0 | 0 | 8 |
| P1 Inbox list (I1-I4) | 0 | 0 | 4 |
| P2 Detail view (D1-D4) | 0 | 0 | 4 |
| P3 Action toolbar + inline stream (A1-A3) | 0 | 0 | 3 |
| P4 file-to-project end-to-end (F1-F3) | 0 | 0 | 3 |
| P5 create-new-project + scope-extractor (S1-S2) | 0 | 0 | 2 |
| P6 Project Emails tab content (X1) | 0 | 0 | 1 |
| P7 Polish + agent QA (Q1-Q3) | 0 | 0 | 3 |
